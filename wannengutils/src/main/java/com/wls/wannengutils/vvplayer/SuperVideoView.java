...
import com.wls.wannengutils.R;
import com.wls.wannengutils.ScreenUtil;
...
public class SuperVideoView extends RelativeLayout {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            setVideoViewScale(ViewGroup.LayoutParams.MATCH_PARENT,ScreenUtil.dipToPx(mContext,290));
